from section_chris.utils_chris import generate_same_different, generate_second_sensory_input_spatial
from section_6.rate_rnn_with_io import ReluRateRNNWithIO
from section_6.utils import generate_batch_of_wm_targets, generate_sensory_input_spatial, generate_blank_sensory_input, loss_function_non_spatial, accuracy_non_spatial
...
## Define our task
n_a = 20    # number of possible inputs
A = 1.0
kappa = 3.0
...
for b in tqdm(range(num_batches)):
    ...
    stim_1_sensory_input = generate_sensory_input_spatial(target_indices, True, n_a, A, kappa)
    ...
    stim_2_sensory_input = generate_second_sensory_input_spatial(target_indices, same_different, True, n_a, A, kappa)

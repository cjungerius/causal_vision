...
## $p = 0, \sigma = 0$
![](progress_images/p0sigma0.png){width=100%}

## $p = 0.5, \sigma = 0$
![](progress_images/p05sigma0.png){width=100%}

## $p = 0.5, \sigma = 0.2$
![](progress_images/p05sigma02.png){width=100%}

## $p = 0.8, \sigma = 0.2$
![](progress_images/p08sigma02.png){width=100%}
...
## Generative model: Simple circular 1D case{.scrollable}
...
assume latent causes mu are uniformly distributed in $[0, 2\pi)$:

$\mu_t \sim U(0, 2\pi)$

if $x_t$ and $x_{t-1}$ do not share a common cause, they are each drawn from circular uniform distribution. 

if $x_t$ and $x_{t-1}$ have a common cause mu, they marginally covary with:

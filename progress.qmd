...
effect of $p$ on bias towards first stimulus

effect of $\sigma_\epsilon$ on bias towards first stimulus
...
if $x_1$ and $x_2$ do not share a common cause, they are each drawn from circular uniform distribution. 

...
N = 10
batch_size = 32
rnn = ReluRateRNNWithIO(dt, N, n_a + 1, n_a, tau)    # Refer to notes to understand why the i/o are these sizes!
...
for b in tqdm(range(num_batches)):
    ...
    stim_sensory_input = generate_sensory_input_non_spatial(target_indices, True, n_a)
    ...
    if b % 200 == 0:
        ...
        print(losses[-10:])
        plt.savefig('section_6/non_spatial/losses.png')
...
fig.savefig('section_6/non_spatial/pca_reprs.png')
